  ...
  return (
    <main className="min-h-screen bg-slate-100 px-5 py-8 text-slate-900">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-4 flex flex-wrap gap-3"><a href={`/platform/businesses/${id}/readiness`} className="inline-block rounded-xl bg-indigo-700 px-4 py-3 font-semibold text-white">Onboarding readiness</a><a href={`/platform/businesses/${id}/modules`} className="inline-block rounded-xl border border-indigo-700 px-4 py-3 font-semibold text-indigo-700">Manage modules</a><a href={`/platform/businesses/${id}/subscription`} className="inline-block rounded-xl border border-indigo-700 px-4 py-3 font-semibold text-indigo-700">Subscription &amp; licence</a><a href={`/platform/businesses/${id}/branches`} className="inline-block rounded-xl border border-indigo-700 px-4 py-3 font-semibold text-indigo-700">Manage branches</a></div>
